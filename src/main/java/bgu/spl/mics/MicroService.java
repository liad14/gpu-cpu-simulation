...
public abstract class MicroService implements Runnable {
    ...
    private ConcurrentHashMap<Class<? extends Message>, Callback> myHashMap;
    MessageBusImpl myMessageBus = MessageBusImpl.getInstance();
    private Queue<Message> myQueue = new LinkedList<>(); //the queue of this Microservice, that MessageBus will add messages to
    /**
    ...
    public final void run() {
        ...
        while (!terminated) {
            ...
            try {
                myMessage = myMessageBus.awaitMessage(this);
            } catch (InterruptedException e){}
            catch(IllegalStateException e2) {}
            Callback myCallBack = myHashMap.get(myMessage.getClass());
            myCallBack.call(myMessage);
        }
